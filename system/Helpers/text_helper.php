...
if (! function_exists('generate_uuid')) {
     ...
     *
     * This function generates a unique identifier (UUID) based on random numbers.
     * It uses the `ramsey/uuid` library to generate the UUID.
     *
    ...
    {
        return \Ramsey\Uuid\Guid\Guid::uuid4()->toString();
    }
}
